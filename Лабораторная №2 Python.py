...
#Пример вывода
#Элемент [1][2]: 6
#Простая очередь: [1, 2, 3]
#Извлечен первый элемент: 1
#Очередь после извлечения: [2, 3]
#Исходный дек: deque([1, 2, 3])
#После добавления: deque([0, 1, 2, 3, 4])
#Удален справа: 4
#Удален слева: 0
#После удаления: deque([1, 2, 3])
#Выполняем: задача A (приоритет: 1)
#Выполняем: задача B (приоритет: 2)
#Выполняем: задача C (приоритет: 3)
